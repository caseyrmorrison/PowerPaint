...
/**
 * The DrawPanel is a JPanel that can be drawn on with shapes.
 * The shapes are a pencil, a line, a rectangle, and an ellipse.
 *
...
public class DrawPanel extends JPanel {
  ...
  /** The list of stored data for each shape. */
  ...
  /** The path being created to draw with a pencil. */
  ...
  private void saveRect() {
    if (my_point1.x <= my_point2.x && my_point1.y <= my_point2.y) {
      keepShape(new Rectangle2D.Double(my_point1.x, my_point1.y, my_point2.x - my_point1.x,
                   my_point2.y - my_point1.y));
    }  else if (my_point1.x >= my_point2.x && my_point1.y <= my_point2.y) {
      keepShape(new Rectangle2D.Double(my_point2.x, my_point1.y, my_point1.x - my_point2.x,
                   my_point2.y - my_point1.y));
    }  else if (my_point1.x >= my_point2.x && my_point1.y >= my_point2.y) {
      keepShape(new Rectangle2D.Double(my_point2.x, my_point2.y, my_point1.x - my_point2.x,
                   my_point1.y - my_point2.y));
    }  else {
      keepShape(new Rectangle2D.Double(my_point1.x, my_point2.y, my_point2.x - my_point1.x,
                   my_point1.y - my_point2.y));
    }
  }
  ...
  private void saveOval() {
    if (my_point1.x <= my_point2.x && my_point1.y <= my_point2.y) {
      ...
      keepShape(new Ellipse2D.Double(my_point2.x, my_point1.y, my_point1.x - my_point2.x,
                   my_point2.y - my_point1.y));
    }  else if (my_point1.x >= my_point2.x && my_point1.y >= my_point2.y) {
      keepShape(new Ellipse2D.Double(my_point2.x, my_point2.y, my_point1.x - my_point2.x,
                   my_point1.y - my_point2.y));
    }  else {
      keepShape(new Ellipse2D.Double(my_point1.x, my_point2.y, my_point2.x - my_point1.x,
                   my_point1.y - my_point2.y));
    }
  }
  ...
  /**
   * Draws the rectangle.
   * @param the_g2d - the graphics object used for drawing.
   */
  private void drawRect(final Graphics2D the_g2d) {
    if (my_point1.x <= my_point2.x && my_point1.y <= my_point2.y) {
      the_g2d.drawRect(my_point1.x, my_point1.y, my_point2.x - my_point1.x,
                   my_point2.y - my_point1.y);
    }  else if (my_point1.x >= my_point2.x && my_point1.y <= my_point2.y) {
      the_g2d.drawRect(my_point2.x, my_point1.y, my_point1.x - my_point2.x,
                   my_point2.y - my_point1.y);
    }  else if (my_point1.x >= my_point2.x && my_point1.y >= my_point2.y) {
      the_g2d.drawRect(my_point2.x, my_point2.y, my_point1.x - my_point2.x,
                   my_point1.y - my_point2.y);
    }  else {
      the_g2d.drawRect(my_point1.x, my_point2.y, my_point2.x - my_point1.x,
                   my_point1.y - my_point2.y);
    }
  }
   ...
   * @param the_g2d - the graphics object used for drawing.
   */
  private void drawOval(final Graphics2D the_g2d) {
    if (my_point1.x <= my_point2.x && my_point1.y <= my_point2.y) {
      the_g2d.drawOval(my_point1.x, my_point1.y, my_point2.x - my_point1.x,
                   my_point2.y - my_point1.y);
    }  else if (my_point1.x >= my_point2.x && my_point1.y <= my_point2.y) {
      the_g2d.drawOval(my_point2.x, my_point1.y, my_point1.x - my_point2.x,
                   my_point2.y - my_point1.y);
    }  else if (my_point1.x >= my_point2.x && my_point1.y >= my_point2.y) {
      the_g2d.drawOval(my_point2.x, my_point2.y, my_point1.x - my_point2.x,
                   my_point1.y - my_point2.y);
    }  else {
      the_g2d.drawOval(my_point1.x, my_point2.y, my_point2.x - my_point1.x,
                   my_point1.y - my_point2.y);
    }
  }
